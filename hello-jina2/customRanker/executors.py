    ...
    def merge_matches(self, docs: Optional[Document] = [], paramerters = {}, **kwargs):
        ...
        for doc in docs:
            ...
            for match_parent_id, matches in parents_matches.items():
                print('all scores', [m.scores[self.metric].value for m in matches])
                best_id = 0
                if self.ranking == 'min':
